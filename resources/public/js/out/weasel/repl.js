...
weasel.repl.process_message = (function (){var method_table__4994__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"weasel.repl","process-message"),new cljs.core.Keyword(null,"op","op",-1882987955),new cljs.core.Keyword(null,"default","default",-1987822328),hierarchy__4998__auto__,method_table__4994__auto__,prefer_table__4995__auto__,method_cache__4996__auto__,cached_hierarchy__4997__auto__));
})();
}
...
weasel.repl.repl_print.cljs$lang$applyTo = (function (seq11629){
return weasel.repl.repl_print.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq11629));
});
...
weasel.repl.console_print.cljs$lang$applyTo = (function (seq11630){
return weasel.repl.console_print.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq11630));
});
...
var G__11632__i = 0, G__11632__a = new Array(arguments.length -  0);
while (G__11632__i < G__11632__a.length) {G__11632__a[G__11632__i] = arguments[G__11632__i + 0]; ++G__11632__i;}
  args = new cljs.core.IndexedSeq(G__11632__a,0);
} 
return G__11631__delegate.call(this,args);};
G__11631.cljs$lang$maxFixedArity = 0;
G__11631.cljs$lang$applyTo = (function (arglist__11633){
var args = cljs.core.seq(arglist__11633);
...
weasel.repl.connect.cljs$core$IFn$_invoke$arity$variadic = (function (repl_server_url,p__11636){
var map__11637 = p__11636;
var map__11637__$1 = ((cljs.core.seq_QMARK_.call(null,map__11637))?cljs.core.apply.call(null,cljs.core.hash_map,map__11637):map__11637);
var print = cljs.core.get.call(null,map__11637__$1,new cljs.core.Keyword(null,"print","print",1299562414),new cljs.core.Keyword(null,"repl","repl",-35398667));
var on_close = cljs.core.get.call(null,map__11637__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var on_error = cljs.core.get.call(null,map__11637__$1,new cljs.core.Keyword(null,"on-error","on-error",1728533530));
var on_open = cljs.core.get.call(null,map__11637__$1,new cljs.core.Keyword(null,"on-open","on-open",-1391088163));
var verbose = cljs.core.get.call(null,map__11637__$1,new cljs.core.Keyword(null,"verbose","verbose",1694226060),true);
var repl_connection = weasel.impls.websocket.websocket_connection.call(null);
cljs.core.swap_BANG_.call(null,weasel.repl.ws_connection,cljs.core.constantly.call(null,repl_connection));

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (repl_connection,map__11637,map__11637__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
...
});})(repl_connection,map__11637,map__11637__$1,print,on_close,on_error,on_open,verbose))
);

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"message","message",-406056002),((function (repl_connection,map__11637,map__11637__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
var map__11638 = cljs.reader.read_string.call(null,evt.message);
...
var message = map__11638__$1;
var op = cljs.core.get.call(null,map__11638__$1,new cljs.core.Keyword(null,"op","op",-1882987955));
var response = cljs.core.pr_str.call(null,weasel.repl.process_message.call(null,message));
return clojure.browser.net.transmit.call(null,repl_connection,response);
});})(repl_connection,map__11637,map__11637__$1,print,on_close,on_error,on_open,verbose))
);

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (repl_connection,map__11637,map__11637__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
...
clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"error","error",-978969032),((function (repl_connection,map__11637,map__11637__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
if(cljs.core.truth_(verbose)){
...
return cljs.core.into.call(null,cljs.core.PersistentHashSet.EMPTY,cljs.core.filter.call(null,((function (gntp,repl_connection,map__11637,map__11637__$1,print,on_close,on_error,on_open,verbose){
return (function (name){
return (goog.dependencies_.visited[(gntp[name])]);
});})(gntp,repl_connection,map__11637,map__11637__$1,print,on_close,on_error,on_open,verbose))
,cljs.core.js_keys.call(null,gntp)));
})();

goog.isProvided_ = ((function (repl_connection,map__11637,map__11637__$1,print,on_close,on_error,on_open,verbose){
return (function (_){
return false;
});})(repl_connection,map__11637,map__11637__$1,print,on_close,on_error,on_open,verbose))
;

goog.require = ((function (repl_connection,map__11637,map__11637__$1,print,on_close,on_error,on_open,verbose){
...
weasel.repl.connect.cljs$lang$applyTo = (function (seq11634){
var G__11635 = cljs.core.first.call(null,seq11634);
var seq11634__$1 = cljs.core.next.call(null,seq11634);
return weasel.repl.connect.cljs$core$IFn$_invoke$arity$variadic(G__11635,seq11634__$1);
});
