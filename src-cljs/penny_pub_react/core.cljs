    ...
    [:div.container
      [:div.row
        [:div.col-md-8.col-md-offset-2
          ...
          [:p "We’ve built this online version so remote teams can play it together in real-time.  To learn more about how our team at AgilityFeat built this real-time application using PubNub and Clojure, " 
